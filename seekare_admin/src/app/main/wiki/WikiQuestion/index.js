...
export const WikiQuestionContent = () => {
  ...
  // const [mdResponseShowMore, setMDResponseShowMore] = useState(false);
  ...
  //   return question?.content.length / 80;
  // }, [question]);
  ...
  // const mdResponseLines = useMemo(() => {
  //   if (!mdResponseDetail?.content) return 0;
  //   return mdResponseDetail?.content.split("<p>").length;
  // }, [mdResponseDetail]);

  // const mdResponseLetters = useMemo(() => {
  //   if (!mdResponseDetail?.content) return 0;
  //   return mdResponseDetail?.content.length;
  // }, [mdResponseDetail]);

  // const onClickMDResponseShowMore = () => {
  //   setMDResponseShowMore(!mdResponseShowMore);
  // };
        ...
        <Box className={classes.box}>
          <Box className={classes.boxBody}>
            ...
            <Box className={classes.questionBody}>
              ...
              />
              {/* {lines > 6 ? (
                <Box className={classes.showMoreBtn} onClick={onClickShowMore}>
