...
export const WelcomeFooter = () => {
  ...
  return (
    <>
      ...
      <Box className={`${classes.root} welcome`}>
        <Box className={classes.features} mt="5">
          ...
          <Grid container className={classes.itemsWrapper}>
            {items.map((item) => (
              <Grid item lg={4} component={Box} p={1} key={item.title} style={{ width: "100%" }} >
        ...
        <Box className={classes.footer}>
          <div className={classes.footerLink} onClick={handleClickLink('ABOUT_MODAL')}>
            About Us
          </div>
          <div className={classes.footerLink} onClick={handleClickLink('CONTACT_US_MODAL')}>
            Contact Us
          </div>
          <div className={classes.footerLink} onClick={handleClickLink('PRIVACY_MODAL')}>
            Privacy Policy
          </div>
          <div className={classes.footerLink} onClick={handleClickLink('TERMS_MODAL')}>
